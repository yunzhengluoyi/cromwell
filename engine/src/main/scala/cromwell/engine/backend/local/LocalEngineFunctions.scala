...
@deprecated(message = "This class will not be part of the PBE universe", since = "May 2nd 2016")
class OldStyleLocalCallEngineFunctions(fileSystems: List[FileSystem], context: OldCallContextOld) extends OldStyleLocalWorkflowEngineFunctions(fileSystems ,context) with OldCallEngineFunctions {
