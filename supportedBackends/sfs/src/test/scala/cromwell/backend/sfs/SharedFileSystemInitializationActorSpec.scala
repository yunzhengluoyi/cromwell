...
class SharedFileSystemInitializationActorSpec extends TestKitSuite("SharedFileSystemInitializationActorSpec")
  ...
  private def getActorRef(workflowDescriptor: BackendWorkflowDescriptor, calls: Seq[Call],
    ...
    val params = SharedFileSystemInitializationActorParams(emptyActor, workflowDescriptor, conf, calls, SharedFileSystemBackendLifecycleActorFactory.RuntimeAttributesBuilder)
